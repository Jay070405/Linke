            ...
            switch (altText) {
                ...
                case 'Photoshop基础':
                    ...
                    modalDescription.innerHTML = `
                        ...
                        <h3>学习收获</h3>
                        <p>通过这个项目，我不仅提升了软件操作能力，还加深了对数字绘画工作流程的理解，为后续更复杂的创作打下了坚实基础。</p>
                    `;
                    break;
                ...
                case '创意透视':
                    modalGallery.innerHTML = `
                        <div class="modal-image-container">
                            <img src="image/school/creative prespetive.jpg" alt="创意透视" class="full-width-image">
                            <div class="image-caption">环境设计</div>
                        </div>
                    `;
                    
                    modalDescription.innerHTML = `
                        <h3>项目背景</h3>
                        <p>这是环境设计课程的作业，要求运用透视原理创建具有空间感和深度的场景。</p>
                        
                        <h3>设计理念</h3>
                        <p>我创作了这个融合东方美学与未来科技感的空间，通过精确的透视关系和光影处理，营造出既宏大又细腻的视觉体验。</p>
                        
                        <h3>技术挑战</h3>
                        <p>项目中最大的挑战是处理复杂的透视关系和多点光源。通过反复研究和实践，我成功地解决了这些问题，使画面既符合透视规律又具有艺术表现力。</p>
                    `;
                    break;
                ...
                case '艺术家':
                    modalGallery.innerHTML = `
                        <div class="modal-image-container">
                            <img src="image/personal/artist.png" alt="艺术家" class="full-width-image">
                ...
                case '寺庙':
                    ...
                    modalGallery.innerHTML = `
                        <div class="modal-image-container">
                            <img src="image/personal/寺庙草稿.png" alt="寺庙" class="full-width-image">
